...
<head>
    ...
    <title>Daftar - Sistem Pengaduan Asrama</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('register') }}" style="opacity: 1; font-weight: 600;">Daftar</a>
    ...
    <div class="main-content">
        <div class="register-container">
            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="form-group">
                    <label for="dorm_name">Nama Asrama</label>
                    <input type="text" id="dorm_name" name="dorm_name" required>
                </div>
                <div class="form-group">
